            ...
            <Row className='about-container'>
                <Col className='  col-7 d-flex flex-column'>
                        ...
                        <Col className='about-content'>
                            <p className='about-p'>
                                Welcome to Edward ScissorHands Barber Shop, where craftsmanship meets style in every snip and clip. 
                                Nestled in the heart of Denver, our dedicated team of skilled barbers brings artistry to the craft of hair grooming.
                            </p>
                            <p className='about-p'>
                                At Edward ScissorHands, we believe in the transformative power of a great haircut. 
                            ...
                            <p className='about-p'>
                                Beyond haircuts, Edward ScissorHands Barber Shop offers a range of grooming services, 
                            ...
                            <p className='about-p'>
                                Join us at Edward ScissorHands Barber Shop, where every visit is an opportunity to experience 
